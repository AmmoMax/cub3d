...
/*   Updated: 2020/11/21 23:22:29 by amayor           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			line_handler(char *line, m_config **config)
{
	...
	else if (ft_strnstr(line, "S ", len)) // TODO: исправить условие поиска строки со спрайтом чтобы не путать с направлением на S
